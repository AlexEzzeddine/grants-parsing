...
gulp.task('default', ['html', 'sass', 'preffix', 'minify-css', 'js-library-min', 'js-custom-min', 'js-concat-customs', 'js-concat-librarys', 'css-libs-concat', 'data-saver', 'img-saver', 'watch']);